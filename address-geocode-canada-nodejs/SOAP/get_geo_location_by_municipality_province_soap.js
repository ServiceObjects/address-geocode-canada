...
/**
 * <summary>
 * A class that provides functionality to call the ServiceObjects Address Geocode CA (AGCA) SOAP service's GetGeoLocationByMunicipalityProvince endpoint,
 ...
 * </summary>
 */
class GetGeoLocationByMunicipalityProvinceSoap {
    /**
     * <summary>
     * Initializes a new instance of the GetGeoLocationByMunicipalityProvinceSoap class with the provided input parameters,
     ...
     */
    constructor(Municipality, Province, LicenseKey, isLive = true, timeoutSeconds = 15) {
    ...
    /**
     * <summary>
     * Asynchronously calls the GetGeoLocationByMunicipalityProvince SOAP endpoint, attempting the primary endpoint
     * first and falling back to the backup if the response is invalid (Error.Number == '4') in live mode
     * or if the primary call fails.
     * </summary>
     * <returns type="Promise<GetGeoLocationByMunicipalityProvinceResponse>">A promise that resolves to a GetGeoLocationByMunicipalityProvinceResponse object containing geocoding details or an error.</returns>
     ...
     * creating a client and processing the response into a GetGeoLocationByMunicipalityProvinceResponse object.
     * </summary>
     * <param name="wsdlUrl" type="string">The WSDL URL of the SOAP service endpoint (primary or backup).</param>
     * <param name="args" type="Object">The arguments to pass to the GetGeoLocationByMunicipalityProvince method.</param>
     * <returns type="Promise<GetGeoLocationByMunicipalityProvinceResponse>">A promise that resolves to a GetGeoLocationByMunicipalityProvinceResponse object containing the SOAP response data.</returns>
    ...
    _callSoap(wsdlUrl, args) {
        return new Promise((resolve, reject) => {
            soap.createClient(wsdlUrl, { timeout: this.timeoutSeconds * 1000 }, (err, client) => {
                ...
                client.GetGeoLocationByMunicipalityProvince(args, (err, result) => {
                    const rawData = result?.Location;
                    try {
                        if (!rawData) {
                            return reject(new Error("SOAP response is empty or undefined."));
                        }
                        const parsed = new GetGeoLocationByMunicipalityProvinceResponse(rawData);
                        resolve(parsed);
                    } catch (parseErr) {
     ...
     * </summary>
     * <param name="response" type="GetGeoLocationByMunicipalityProvinceResponse">The GetGeoLocationByMunicipalityProvinceResponse object to validate.</param>
...
export { GetGeoLocationByMunicipalityProvinceSoap };