...
class GetGeoLocationByMunicipalityProvinceSoap:
    ...
    def get_geo_location_by_municipality_province(
        self, municipality: str, province: str
    ) -> Object:
        """
        Calls the GetGeoLocationByMunicipalityProvince SOAP API to retrieve the information.
        ...
        try:
            ...
            response = client.service.GetGeoLocationByMunicipalityProvince(
                **call_kwargs
            )
